 ...
 */
public class PomskyNamedGroupRenameInputValidator implements RenameInputValidatorEx {
  @NotNull
  @Override
  public ElementPattern<? extends PsiElement> getPattern() {
    return PlatformPatterns.psiElement(PomskyNamedCapturingGroupExpressionPsiElement.class);
  }
